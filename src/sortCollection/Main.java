...
public class Main {
    public static void main(String args[]) {
        ...
        FindTheMinimum fm = new FindTheMinimum();
        Removeood ro = new Removeood();
        ...
        System.out.println("Remove ood Numbers");
        pa.PrintArray(ro.removeood(arr));
